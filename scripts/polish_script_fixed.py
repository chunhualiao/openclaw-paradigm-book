#!/usr/bin/env python3
"""
Fixed script to polish and format the manuscript for 'The OpenClaw Paradigm: AI-Native Development in Practice'
"""
...
def extract_chapters(content):
    """Extract chapters from manuscript content - fixed version"""
    lines = content.split('\n')
    chapters = []
    current_chapter = None
    current_content = []
    
    # Chapter patterns to identify actual chapters
    chapter_patterns = [
        r'^# The OpenClaw Paradigm:',
        r'^# Introduction:',
        r'^# Chapter \d+:',
        r'^# Index$'
    ]
    ...
    for line in lines:
        ...
        if is_chapter:
            ...
            current_chapter = line[2:].strip()  # Remove '# '
...
def create_detailed_toc(chapters):
    """Create detailed table of contents with chapter summaries - fixed version"""
    ...
    chapter_summaries = {
        "The OpenClaw Paradigm: AI-Native Development in Practice": "Complete manuscript title page and metadata.",
        ...
        "Chapter 3: Case Studies in AI-Native Development": "Examines skill-based architecture, design patterns, and real-world case studies.",
        ...
        "Chapter 7: Cron and Scheduled Automation Patterns": "Examines patterns for scheduled automation and autonomous system operations.",
        "Chapter 8: Autonomous Systems Design": "Surveys the tooling ecosystem and API integration patterns.",
        "Chapter 9: Cost Optimization Patterns": "Investigates patterns for managing API costs and resource consumption.",
        "Chapter 10: Debugging AI-Native Systems": "Explores debugging patterns, error recovery, and system monitoring.",
        "Chapter 11: Security Patterns in AI-Native Development": "Examines security considerations, privacy patterns, and operational security.",
        "Chapter 12: The Future of AI-Native Development": "Looks ahead at emerging trends, challenges, and future directions.",
        "Chapter 13: Tooling Ecosystem": "Surveys development tools, frameworks, and infrastructure patterns.",
        "Chapter 14: Education and Community": "Explores education resources, community patterns, and contribution guidelines.",
        "Index": "Comprehensive index of topics covered in the book."
    }
    ...
    for chapter in chapters:
        ...
        if title in chapter_summaries:
            ...
            # Fallback for any chapter not in our summary list
            toc += f"### {title}\n"
            toc += f"*Summary: Detailed exploration of {title.lower()}*\n\n"
